        ...
        <div className="user-actions desktop-actions">
          {user ? (
            <>
              ...
              <NavLink to="/historial" className="navbar-link">Historial</NavLink>
      ...
      {isMobileMenuOpen && (
        <div className="mobile-menu">
          ...
          {user ? (
            <>
              <span>¡Hola, {user.nombre}!</span>
              {user.rol === 'ADMIN' && <NavLink to="/admin" onClick={closeMobileMenu}>Panel</NavLink>}
              <NavLink to="/historial" onClick={closeMobileMenu} className="navbar-link">Historial</NavLink>
