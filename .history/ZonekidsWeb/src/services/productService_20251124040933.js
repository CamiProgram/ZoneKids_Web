...
export const productService = {
  ...
  uploadImages: async (files) => {
    try {
      ...
      // Filtrar archivos válidos y agregarlos con claves correctas
      ...
      // Agregar cada archivo con la clave esperada por el backend
      validFiles.forEach((file, index) => {
        formData.append(`imagen`, file); // El backend espera 'imagen' como clave
      });
