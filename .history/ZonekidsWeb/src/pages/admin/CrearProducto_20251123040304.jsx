...
export const CrearProducto = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Validar que precio sea un número entero
        if (!Number.isInteger(parseFloat(precio)) || parseFloat(precio) <= 0) {
            setError('El precio debe ser un número entero positivo sin decimales.');
            return;
        }

        // Validar que precioOriginal sea entero si está ingresado
        if (precioOriginal && (!Number.isInteger(parseFloat(precioOriginal)) || parseFloat(precioOriginal) <= 0)) {
            setError('El precio original debe ser un número entero positivo sin decimales.');
            return;
        }
