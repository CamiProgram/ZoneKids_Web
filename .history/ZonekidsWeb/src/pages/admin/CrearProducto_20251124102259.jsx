...
export const CrearProducto = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('📤 Paso 1: Subiendo 3 imágenes...');
            // Filtrar solo los archivos válidos (no null)
            ...
            try {
                ...
                // Paso 2: Crear el producto SIN imágenes en el body (vacío)
                console.log('📝 Paso 2: Creando producto sin imágenes...');
                const productData = {
                    nombre,
                    descripcion,
                ...
                // Paso 3: Actualizar imágenes con PATCH /api/v1/productos/{id}/imagenes
                console.log('🖼️ Paso 3: Actualizando imágenes del producto con PATCH...');
                console.log('📋 Enviando', imagenesSubidas.length, 'URLs al PATCH');
                ...
                console.error('❌ Error en el flujo de upload:', uploadError);
                setError('Error en el upload de imágenes: ' + uploadError.message);
                setLoading(false);
                return;
            }
        } catch (err) {
