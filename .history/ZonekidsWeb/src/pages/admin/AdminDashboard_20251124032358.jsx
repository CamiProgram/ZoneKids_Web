                ...
                <p>
                  ...
                  {editingStatus === selectedOrder.id ? (
                    <select 
                      ...
                      disabled={savingStatus === selectedOrder.id}
                      className="status-select"
                      style={{ marginLeft: '10px', padding: '6px 12px', borderRadius: '4px', border: '1px solid #ddd', opacity: savingStatus === selectedOrder.id ? 0.6 : 1 }}
                    >
                    ...
                    <>
                      <span style={{ color: getStatusColor(selectedOrder.estado), fontWeight: 'bold', marginRight: '10px' }}>
                        {savingStatus === selectedOrder.id ? '⏳ Guardando...' : getStatusLabel(selectedOrder.estado)}
                      </span>
                      <button 
                        ...
                        style={{
                          padding: '6px 12px',
                          backgroundColor: savingStatus === selectedOrder.id ? '#ccc' : '#0d6efd',
                          color: 'white',
                          border: 'none',
                          borderRadius: '4px',
                          cursor: savingStatus === selectedOrder.id ? 'not-allowed' : 'pointer',
                          fontSize: '14px'
                        }}
                      >
                        {savingStatus === selectedOrder.id ? '⏳' : '✎'} {savingStatus === selectedOrder.id ? 'Guardando' : 'Editar'}
                      </button>
                    </>
                  )}
                </p>
