    ...
    public CommandLineRunner initData(UserRepository userRepository, ProductoRepository productoRepository) {
        return args -> {
            try {
                ...
                entityManager.flush();
                System.out.println("✅ Datos anteriores eliminados: " + productosEliminados + " productos, " + usuariosEliminados + " usuarios");
            } catch (Exception e) {
                System.out.println("⚠️  Error al limpiar datos anteriores: " + e.getMessage());
                e.printStackTrace();
            }
