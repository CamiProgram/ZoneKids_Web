        ...
        try {
            ...
            if (userOptional.isEmpty() || !userOptional.get().getEstado().equals("activo")) {
                return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                        .body(new AuthResponseDto(null, "Credenciales inválidas o cuenta deshabilitada"));
            }
            ...
            return ResponseEntity.ok(new AuthResponseDto(
                    token,
                    "Login exitoso - Rol: " + user.getRol().getDescripcion()
            ));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(new AuthResponseDto(null, "Error en el servidor: " + e.getMessage()));
        }
    }
