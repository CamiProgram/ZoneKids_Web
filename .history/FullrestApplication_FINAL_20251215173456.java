...
@ComponentScan(basePackages = "com.zonekids.springboot.api.zonekidsBackend")
            ...
            try {
                ...
                if (productoRepository.count() == 0) {
                    ...
                    for (int i = 0; i < 10; i++) {
                        ...
                        // URLs de Picsum Photos - Funcionan con CORS y cargan rápido
                        int baseId = (i + 1) * 1000;
                        imagenes.add("https://picsum.photos/300/300?random=" + baseId);
                        imagenes.add("https://picsum.photos/300/300?random=" + (baseId + 1));
                        imagenes.add("https://picsum.photos/300/300?random=" + (baseId + 2));

                        producto.setImagenesUrl(imagenes);
                        productoRepository.save(producto);
                        productosCreados++;
                    }
                    System.out.println("✅ " + productosCreados
                            + " productos creados exitosamente (con 3 imágenes reales cada uno)");
                } else {
